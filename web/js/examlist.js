...
function ExamList(parentDOM) {
	...
	this.settings = {
		'default': {
			...
			sort1: 'semester,1',
			filters: [],
			columns: ['exam_id', 'student_id', 'semester', 'stg', 'name', 'status', 'recognized', 'mandatory', 'try_nr', 'type', 'bonus', 'grade', 'by', 'by_surname', 'by_forename'],
			displayFilters: true,
...
//	columns: EDV Nr., Prüfungsleistung Name, Pflicht, Vers., Art, ECTS
	...
	if (this.settingId == 'student') {
		...
		this.columnData = {
			...
			'version': {id: 'version', label: 'Version', title: 'Prüfungsversion', formatting: 'int'},
