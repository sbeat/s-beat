...
function ExamInfoList(parentDOM) {
	...
	this.columnData = {
		'exam_info_id': {
			id: 'exam_info_id',
			label: 'ID',
			title: 'Eindeutige ID der Prüfungsleistung',
			formatting: 'str',
			sortBy: '_id',
			group: 'Leistung'
		},
		'exam_id': {
			id: 'exam_id',
			label: CONFIG.exam_id_label,
			title: CONFIG.exam_id_desc,
			formatting: 'int',
			sortBy: 'exam_id',
			group: 'Leistung'
		},
		'stg': {
			id: 'stg',
			label: 'Studiengangsgruppe',
			title: 'Studiengangsgruppe',
			formatting: 'stg',
			group: 'Leistung'
		},
		'stg_original': {
		...
		'name': {
			id: 'name',
			label: 'Prüfungsleistung Name',
			title: 'Prüfungsleistung Name',
			formatting: 'str',
			group: 'Leistung'
		},
		'has_grade': {
			id: 'has_grade',
			label: 'Hat Note',
			title: 'Ob für diese Leistung Noten vergeben wurden.',
			formatting: 'yesno',
			group: 'Leistung'
		},
		'bonus': {id: 'bonus', label: CONFIG.cp_label, title: CONFIG.cp_label, formatting: 'int', group: 'Leistung'},
		'version': {id: 'version', label: 'Version', title: 'PO Version', formatting: 'int', group: 'Leistung'},
		'count_exams': {
			id: 'count_exams',
			label: 'Anzahl',
			title: 'Gesamtzahl aller Leistungen',
			formatting: 'int',
		...
		'count_successful': {
			id: 'count_successful',
			label: 'Bestanden',
			title: 'Anzahl bestandene Leistungen',
			formatting: 'int',
		...
		'count_failed': {
			...
			title: 'Anzahl nicht bestandene Leistungen',
			formatting: 'int',
			group: 'Leistung.Nicht bestanden'
		},
		'count_applied': {
			id: 'count_applied',
			label: 'Anzahl mit Status=AN',
			title: 'Anzahl Leistungen mit Status=AN',
			formatting: 'int',
			group: 'Leistung.Anmeldungen'
		},
		'success_perc': {
			id: 'success_perc',
			label: 'Bestanden in %',
			title: 'Prozentanteil bestandender Leistungen',
			formatting: 'percent',
			group: 'Leistung.Bestanden'
		},
		'failed_perc': {
			id: 'failed_perc',
			label: 'Nicht bestanden in %',
			title: 'Prozentanteil nicht bestandender Leistungen',
			formatting: 'percent',
			group: 'Leistung.Nicht bestanden'
		},
		'semester_data.CURRENT.exams': {
			id: 'semester_data.CURRENT.exams',
			label: 'Anzahl Anmeldungen dieses Semester',
			title: 'Anzahl Leistungen im aktuellen Semester',
			formatting: 'int',
			group: 'Leistung.Anmeldungen'
		},
		'semester_data.CURRENT.successful': {
			id: 'semester_data.CURRENT.successful',
			label: 'Bestanden dieses Semester',
			title: 'Anzahl bestandene Leistungen im aktuellen Semester',
			formatting: 'int',
			group: 'Leistung.Bestanden'
		},
		'semester_data.CURRENT.failed': {
			id: 'semester_data.CURRENT.failed',
			label: 'Nicht bestanden dieses Semester',
			title: 'Anzahl nicht bestandene Leistungen im aktuellen Semester',
			formatting: 'int',
			group: 'Leistung.Nicht bestanden'
		},
		'semester_data.CURRENT.applied': {
			id: 'semester_data.CURRENT.applied',
			label: 'Status=AN dieses Semester',
			title: 'Anzahl Leistungen mit dem Status=AN im aktuellen Semester',
			formatting: 'int',
			group: 'Leistung.Anmeldungen'
		},
		'semester_data.CURRENT.success_perc': {
			id: 'semester_data.CURRENT.success_perc',
			label: 'Bestanden dieses Semester in %',
			title: 'Prozentanteil bestandender Leistungen in diesem Semester',
			formatting: 'percent',
			group: 'Leistung.Bestanden'
		},
		'semester_data.CURRENT.failed_perc': {
			id: 'semester_data.CURRENT.failed_perc',
			label: 'Nicht bestanden dieses Semester in %',
			title: 'Prozentanteil nicht bestandender Leistungen in diesem Semester',
			formatting: 'percent',
			group: 'Leistung.Nicht bestanden'
		},
		'semester_data.LAST.exams': {
			id: 'semester_data.LAST.exams',
			label: 'Anzahl Anmeldungen letztes Semester',
			title: 'Anzahl Prüfungsanmeldungen letztes Semester',
			formatting: 'int',
			group: 'Leistung.Anmeldungen'
		},
		'semester_data.LAST.successful': {
			id: 'semester_data.LAST.successful',
			label: 'Bestanden letztes Semester',
			title: 'Anzahl bestandene Leistungen im letzten Semester',
			formatting: 'int',
			group: 'Leistung.Bestanden'
		},
		'semester_data.LAST.failed': {
			id: 'semester_data.LAST.failed',
			label: 'Nicht bestanden letztes Semester',
			title: 'Anzahl nicht bestandene Leistungen im letzten Semester',
			formatting: 'int',
			group: 'Leistung.Nicht bestanden'
		},
		'semester_data.LAST.applied': {
			id: 'semester_data.LAST.applied',
			label: 'Status=AN letztes Semester',
			title: 'Anzahl Leistungen mit dem Status=AN im letzten Semester',
			formatting: 'int',
			group: 'Leistung.Anmeldungen'
		},
		'semester_data.LAST.success_perc': {
			id: 'semester_data.LAST.success_perc',
			label: 'Bestanden letztes Semester in %',
			title: 'Prozentanteil bestandender Leistungen im letzten Semester',
			formatting: 'percent',
			group: 'Leistung.Bestanden'
		},
		'semester_data.LAST.failed_perc': {
			id: 'semester_data.LAST.failed_perc',
			label: 'Nicht bestanden letztes Semester in %',
			title: 'Prozentanteil nicht bestandender Leistungen im letzten Semester',
			formatting: 'percent',
			group: 'Leistung.Nicht bestanden'
		},
		'semesters': {
			id: 'semesters',
			label: 'Semester',
			title: 'Semester in welchen die Leistung geschrieben wurde',
			formatting: 'semester',
			group: 'Leistung'
		}
